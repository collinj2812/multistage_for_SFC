...
class MPC_BLL:
    ...
    def setup_mpc(self, n_horizon, t_step, bounds, l):
        ...
        self.db_model = data_based_do_mpc_model_bll.data_based_model(self.nn_model.casadi_model, self.nn_model.std_with_noise, self.data.l, no_states=len(self.data.keys_states), no_inputs=len(self.data.keys_inputs), opt_inputs=self.data.keys_inputs)
        ...
        p_template['_p', :, 'uncertainty'] = [0, 1, -1]
